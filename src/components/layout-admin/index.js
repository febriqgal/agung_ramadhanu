...
const LayoutAdmin = ({ children }) => {
  const navigation = [
    ...
    // { name: "Tambah Download", icon: tambahberita, href: "/dashboard-admin/download" },
    {
      name: "Kelola Header",
      icon: home,
      href: "/dashboard-admin/ganti-header",
    },
    { name: "Kelola Pengguna", icon: home, href: "/dashboard-admin/users" },
    {
      name: "Kelola Pengaduan",
      icon: home,
      href: "/dashboard-admin/pengaduan",
    },
    { name: "Kelola Berita", icon: home, href: "/dashboard-admin/berita" },
    { name: "Keluar", icon: home, href: "/" },
  ];
  ...
  return (
    <>
      <Toaster />
      <Head>
        <title>dashboard-admin - BPTD III Sumbar</title>
